...
index 72897cea81a54cfea50ca934b7a156f7377d45ee..7a7c7bdef1096edcf7af699d85de08831f7856d3 100644
...
@@ -277,305 +454,495 @@ export default function ConsultaDetalhesV2() {
         });
       };
     } catch (error) {
...
+                <fieldset disabled={isReadOnly} className={isReadOnly ? "opacity-60 cursor-not-allowed" : ""}>
                 ...
                 <div className="grid gap-4">
                   ...
                   <div className="grid gap-2">
                     ...
                     <Textarea
@@ -637,132 +1004,516 @@ export default function ConsultaDetalhesV2() {
...
@@ -932,51 +1683,108 @@ export default function ConsultaDetalhesV2() {
                         size="sm"
